...
def llm_prompt_concept_term_extraction(context: str) -> List[Dict[str, str]]:
    """Prompt template for concept term extraction with the most of modern LLMs.
...
def llm_prompt_relation_term_extraction(context: str) -> List[Dict[str, str]]:
    """Prompt template for relation term extraction with the most of modern LLMs.
...
def llm_prompt_term_enrichment(context: str) -> List[Dict[str, str]]:
    """Prompt template for term enrichment with the most of modern LLMs.
...
def llm_prompt_concept_extraction(
    doc_context: str, ct_labels: str
) -> List[Dict[str, str]]:
    """Prompt template for concept extraction with the most of modern LLMs.
...
def llm_prompt_relation_extraction(
    doc_context: str, ct_labels: str
) -> List[Dict[str, str]]:
    """Prompt template for relation extraction with the most of modern LLMs.
...
def llm_prompt_hierarchisation(
    doc_context: str, concepts_description: str
) -> List[Dict[str, str]]:
    """Prompt template for hierarchisation with the most of modern LLMs.
...
def llm_prompt_owl_axiom_extraction(
    kr_description: str, namespace: str
) -> List[Dict[str, str]]:
    """Prompt template for axiom extraction with the most of modern LLMs.
